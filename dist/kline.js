...
function () {
  ...
  _createClass(Control, null, [{
    ...
    value: function requestSuccessHandler(res) {
      ...
      var updateDataRes = __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.chartMgr.updateData("frame0.k0", __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.data);
